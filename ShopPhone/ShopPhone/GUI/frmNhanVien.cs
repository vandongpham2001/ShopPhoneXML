...
namespace ShopPhone.GUI
{
    public partial class frmNhanVien : Form
    {
        ...
        string MaNhanVien, TenNhanVien, NgaySinh, GioiTinh, SDT, Email;
        public frmNhanVien()
        {
            InitializeComponent();
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //String dt=dtpNgaySinh.Value.ToString("yyyy-MM-dd");
                nv.themNV(MaNhanVien, TenNhanVien, NgaySinh, SDT, Email, GioiTinh);
                MessageBox.Show("Ok");
                hienthiNhanVien();
                txtMaNhanVien.Focus();
            }
        ...
        private void tbnSua_Click(object sender, EventArgs e)
        {
            ...
            //DateTime dt = DateTime.Parse(dtpNgaySinh.Text);
            //String dt = dtpNgaySinh.Value.ToString("yyyy-MM-dd");
            nv.suaNV(MaNhanVien, TenNhanVien, NgaySinh, SDT, Email, GioiTinh);
            MessageBox.Show("Ok");
            hienthiNhanVien();
        }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                object[] list = { dv[index]["MaNhanVien"], dv[index]["TenNhanVien"], dv[index]["NgaySinh"], dv[index]["SDT"], dv[index]["Email"], dv[index]["GioiTinh"] };
                dt.Rows.Add(list);
                dgvNhanVien.DataSource = dt;
                txtTimKiem.Text = "";
            }
        ...
        private void dgvNhanVien_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtEmail.Text = dgvNhanVien.Rows[d].Cells[4].Value.ToString();
